...
@lazySingleton
class GetCachedDemo implements UseCase<Demo, NoParams> {
  GetCachedDemo({required this.repository});

  final DemoRepository repository;

  @override
  Future<Either<Failure, Demo>> call(NoParams params) async {
    return repository.getCachedDemo();
  }
}
